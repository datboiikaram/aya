...
export default function App() {
  ...
  return (
    <div className="h-[100vh]  font-Messiri flex flex-col gap-3 items-center justify-center p-6">
      <p>تم تغيير محتوي الصفحة بسبب اللي حصل</p>
      <p className="text-5xl font-bold">فرصة سعيدة</p>
    </div>
